...
<section class="auth-panel">
    <x-auth-brand />
    <div class="auth-card">
        <div class="auth-card__header"><h1 class="auth-card__title">Choose a new password</h1><p class="auth-card__copy">Create a strong password for your account.</p></div>
